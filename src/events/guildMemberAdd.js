...
`:tada: ${member} **${setupData.guildName}'ya** hoş geldin! Sunucumuz seninle beraber **${member.guild.members.cache.size}** kişi oldu!
...
Sol tarafta bulunan **${setupData.confirmationName}** kanallarına girerek yetkililerimize isim yaş vererek kayıt olabilirsin. <@&1203122769974398998>
